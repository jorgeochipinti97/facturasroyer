  ...
  return (
    <Box display="flex" flexDirection="column">
      <Box
        ...
        sx={{ minHeight: "29.7cm", width: "21cm" }}
        ref={printRef}
        flexWrap="wrap"
      >
        <Box>
          <Box
            ...
            sx={{ backgroundColor: "#043464" }}
          >
            <Box display="flex" justifyContent="center" sx={{ ml: 5 }}>
              <Image
                src="https://res.cloudinary.com/djk4q3tys/image/upload/v1664297333/rkwkiqfct0mjl4q7vfnv.png"
                width={500}
                height={200}
              />
            </Box>
          ...
          <Box display='flex' justifyContent='space-around'>
            <Box>
              <Typography
                variant="h5"
                sx={{ textAlign: "start", color: "black", m: 1 }}
              >
                Order Nº: {order.nOrder}
              </Typography>
            </Box>
            <Box>
              <Typography
                variant="subtitle1"
                sx={{ fontWeight: 800, color: "#043464" }}
              >
                Date:
              </Typography>
              <Typography
                variant="subtitle1"
                sx={{ fontWeight: 800, ml: 1, color: "black" }}
              >
          ...
          <Box sx={{ width: 800, p: 2 }}>
            ...
            >
              ...
              <Box display="flex"  sx={{mt:2}}>
                ...
                <Typography
                  variant="body1"
                  sx={{ fontWeight: 800,fontSize:14, ml: 1, color: "black" }}
                >
          ...
          >
            <Box display="flex" justifyContent="center" sx={{ mt: 2 }}>
              <Typography
                variant="h5"
                sx={{ textAlign: "start", fontWeight: 800, color: "black" }}
              >
                Payment Method: {capitalize(order.paymentMethod)}
              </Typography>
            </Box>
            <Box display="flex" justifyContent="center" sx={{ mt: 2 }}>
              <Typography
                variant="h4"
                sx={{ textAlign: "start", fontWeight: 800, color: "#043464" }}
              >
                Gross total: {format(order.price)}{" "}
                {order.isPesos ? "ARS" : "USD"}{" "}
              </Typography>
            </Box>
          </Box>
        </Box>
